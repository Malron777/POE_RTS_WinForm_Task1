...
{
  public class RangedUnit : Unit, IPosition
  {
    public int xPos
    {
      get
    ...
    public RangedUnit(int aPositionX, int aPositionY, int aHealth, int aSpeed, int aAttack, int aAttackRange, string aFaction, char aSymbol)
